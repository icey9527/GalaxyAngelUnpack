        ...
        for file in files:
            if file.endswith('.tbl.json'):
                ...
                if '■' in tbl_file_name:
                    ...
                    original_tbl_path = os.path.join(original_folder, dir_part, file_part)
                    output_tbl_path = os.path.join(output_folder, dir_part, file_part)
                else:
...
# 使用示例
original_folder = 'adv'  # 原始tbl文件目录
json_folder = 'adv_tbl'  # JSON翻译文件目录
output_folder = 'new_adv'  # 输出翻译后的tbl文件目录
